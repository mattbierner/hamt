...
const defaultValBind = function(f, defaultValue) {
    return function(x) {
...
*/
const modifyHash = hamt.modifyHash = function(f, hash, key, defaultValue, map) {
...
Map.prototype.modifyHash = function(hash, key, f, defaultValue) {
    return arguments.length <= 3 ?
        modifyHash(f, hash, key, this) :
        modifyHash(f, hash, key, defaultValue, this);
};
...
/**
    ...
    @see `modifyHash`
*/
const modify = hamt.modify = function(f, key, defaultValue, map) {
    return arguments.length <= 3 ?
        modifyHash(f, hash(key), key, defaultValue) :
        modifyHash(f, hash(key), key, defaultValue, map);
}

Map.prototype.modify = function(key, f, defaultValue) {
    return arguments.length <= 2 ?
        modify(f, key, this) :
        modify(f, key, defaultValue, this);
};

...
define(["require", "exports"], (function(require, exports) {
        ...
        mergeLeaves = (function(shift, n1, n2) {
            return (isEmpty(n2) ? n1 : (function() {
                ...
                return ((h1 === h2) ? new(Collision)(h1, [
                    ...
                    return new(IndexedNode)((toBitmap(subH1) | toBitmap(subH2)), ((subH1 ===
                        subH2) ? [mergeLeaves((shift + size), n1, n2)] : ((subH1 <
                        subH2) ? [n1, n2] : [n2, n1])));
                })());
            })());
        }),
    ...
    (IndexedNode.prototype.get = (function(shift, h, k) {
        ...
        return ((self.mask & toBitmap(frag)) ? self.children[fromBitmap(self.mask, frag)].get((shift +
            size), h, k) : nothing);
    }));
    ...
    (IndexedNode.prototype.modify = (function(shift, f, h, k) {
        var self = this,
            ...
            left = __o[0],
            right = __o[1],
            subNodes = (removed ? left.concat(rest(right)) : (added ? left.concat([child], right) :
        ...
        return ((!bitmap) ? empty : (((bound === 0) && isLeaf(self.children[0])) ? self.children[0] : (
            (added && (bound >= maxIndexNode)) ? expand(frag, child, bitmap, subNodes) : new(
    ...
    (ArrayNode.prototype.modify = (function(shift, f, h, k) {
        ...
        return (added ? new(ArrayNode)((self.count + 1), arrayUpdate(frag, newChild, self.children)) :
            (removed ? (((self.count - 1) <= minArrayNode) ? pack(frag, self.children) : new(ArrayNode)
                ((self.count - 1), arrayUpdate(frag, empty, self.children))) : new(ArrayNode)(self.count,
